...
impl Cpu {
    ...
    /* 2x */[JrNzE8     , LdR16Imm16(HL), LdHlIncMemA  , IncR16(HL)  , IncR8(H)    , DecR8(H)    , LdR8Imm8(H) , NoImpl      , JrZE8      , AddHlR16(HL), LdAHlIncMem  , DecR16(HL), IncR8(L)    , DecR8(L)   , LdR8Imm8(L) , NoImpl     ],
    /* 3x */[JrNcE8     , LdSpImm16     , LdHlDecMemA  , IncR16(SP)  , IncHlMem    , DecHlMem    , LdHlMemImm8 , NoImpl      , JrCE8      , AddHlR16(SP), LdAHlDecMem  , DecR16(SP), IncR8(A)    , DecR8(A)   , LdR8Imm8(A) , NoImpl     ],
    ...
    /* 7x */[LdHlMemR8(B), LdHlMemR8(C), LdHlMemR8(D)  , LdHlMemR8(E), LdHlMemR8(H), LdHlMemR8(L), NoImpl      , LdHlMemR8(A), LdR8R8(A,B), LdR8R8(A,C) , LdR8R8(A,D)  , LdR8R8(A,E), LdR8R8(A,H), LdR8R8(A,L), LdR8HlMem(A), LdR8R8(A,A)],
